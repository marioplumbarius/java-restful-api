...
public class UserDTOSerializer extends JsonSerializer<UserDTO> {
	...
	@Override
	public void serialize(UserDTO user, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
	...
	private void writeAttributesWrapper(UserDTO user, JsonGenerator jgen) throws IOException {
	...
	private void writeCustomAttributes(UserDTO user, JsonGenerator jgen) throws IOException {
	...
	private void writeDefaultAttributes(UserDTO user, JsonGenerator jgen) throws IOException {
